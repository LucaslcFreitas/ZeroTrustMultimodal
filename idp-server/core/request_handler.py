...
class RequestHandler:
    ...
    def handle_request(self, request_data: Dict, device_iot_id: str, device_id: str, client_ip: str) -> Dict:
        ...
        return handler(request_data, device_iot_id, device_id, client_ip)
    ...
    def _handle_logout(self, request_data: Dict, device_iot_id: str, device_id: str, client_ip: str) -> Dict:
        # Processa logout
